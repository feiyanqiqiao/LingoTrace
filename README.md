...
这些句子只是示例，不是固定提示词。Agent Skill 会先识别真实学习意图，再选择对应能力；遇到“请更新总训练表”这类可能同时表示复习结算或视图维护的表达时，会先确认你的意思。

新增听力笔记、来源笔记和口语卡时，系统会避免覆盖你已经手工整理过的笔记。复习材料合并、状态修改和每日复习结算会先让我确认将要新增或修改的内容。
