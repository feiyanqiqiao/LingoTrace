...
def plan_english_vault_initialization(target_root: str | Path) -> CommandReport:
    ...
    return CommandReport(
        ...
        read_files=[
            ...
            "lingotrace/packs/english/paths.json",
        ],
    ...
    planned: list[dict[str, Any]] = [
        {
            ...
            "reason": "default English Vault context",
        ...
        },
        {
            ...
            "action": "write_json",
            "artifact_class": "recreate-from-pack",
            "reason": "default English path roles",
