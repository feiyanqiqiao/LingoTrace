...
allowed_re='^(\.github/dependabot\.yml|\.github/workflows/[^/]+\.ya?ml|\.gitignore|AGENTS\.md|README\.md|LICENSE|SECURITY\.md|docs/[^/]+\.md|系统配置/|学习系统/总训练\.base|codex-skills/|tools/README\.md|tools/listening-transcribe-official/|tools/vault-structure/|tools/git/)'
